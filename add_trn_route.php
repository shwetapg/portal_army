...
?> 
  ...
  <?php  
        ...
        $url1 = 'https://api.neptune.bitjiniapps.com/add_route/';
        $data1 = array(
                    'route' => $rarr,
                  );
          ...
          // print_r($arr3);
          // echo "string";
        echo '<script>alert("Added More Route Details Successfully");</script>';
        echo "<script>location='training_db.php'</script>";
       }
    ?>

    <?php
    $url2 = 'https://api.neptune.bitjiniapps.com/live_training_detail/';
    $options = array(
            'http' => array(
              'header'  => array(
                'Authorization: '.'Token 7733513f8a2d44f607ebd4135a5d6a484644776b',
        ...
        <div class="content cntnt">
            <div class="animated fadeIn">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <div class="col-xs-11 col-sm-11">
                            ...
                            <div class="row form-group">
                               ...
                               <div class="col-md-2" style=""><input type="text" id="ref.no" name="" class="form-control" value="<?php echo $arr['livetraining_detail']['ref_no']; ?>" readonly></div>
                               <div class="col-md-5"></div>
                               <div class="col-md-1"><label for="date">Date:</label></div>
                               <div class="col-md-3" style=""><input type="date" id="date" name=""  class="form-control" style="width: 115%;" value="<?php echo date('Y-m-d');?>" readonly></div>
                            </div>
                            ...
                            <div class="row form-group">
                               ...
                               <div class="col-md-3"><input type="number" id="duration" name="" class="form-control" value="<?php echo $arr['livetraining_detail']['total_duration']; ?>" readonly></div>
                            </div>   
                            
                            <div class="row form-group">
                               <div class="col col-md-3" style="text-align: end;"><label for="marks">Total Marks:</label></div>
                               <div class="col-md-3"><input type="number" id="marks" name="" class="form-control" value="<?php echo $arr['livetraining_detail']['total_marks']; ?>" readonly></div>
                            </div>
                        ...
                        <div style="margin-left: 2%;margin-bottom:3%;">Routes:</div>
                      <?php $count1=0; foreach ($arr['route'] as $jsonArray1) {
                        if(empty($jsonArray1)){ $count1;} else {$count1++;}
                     ?> 
                        ...
                        <div class="row">
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            <div class="col col-md-6" style="text-align: end;"><label for="route1">Route <?php echo $count1; ?>:</label></div>
                            <div class="col-12 col-md-6"><input type="text" id="" name="" class="form-control" style="" value="<?php echo $jsonArray1['routes']['route_name']; ?>" readonly></div>
                          </div>
                         </div> 
                          <div class="col-xs-6 col-sm-6"></div>    
                         </div>

                         <?php $count2=0; foreach ($jsonArray1['check_points'] as $jsonArray2) { 
                          ?> 
                       <?php  foreach ($jsonArray2['check_point'] as $jsonArray3) {
            
                       ?> 
                         <div class="row">
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            <div class="col col-md-6" style="text-align: end;"><label for="checkpt">Check Points  <?php if(empty($jsonArray3)){ $count2;} else {$count2++;} echo $count2; ?>:</label></div>
                            <div class="col-12 col-md-6"><input type="text" id="" name="" class="form-control" value="<?php echo $jsonArray3['check_point_name']; ?>" readonly></div>
                          </div>
                         </div> 
                          <div class="col-xs-6 col-sm-6"></div>    
                         </div>
                         ...
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-6">
                            <select  name="" class="form-control" readonly>
                             <option value="<?php echo $jsonArray3['cp_status']; ?>"><?php echo $jsonArray3['cp_status']; ?></option>
                         ...
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3"><input type="text" id="" name="" class="form-control" style="width: 130%;" value="<?php echo $jsonArray3['distance']; ?>" readonly></div>
                         ...
                         <div class="col-xs-2 col-sm-2">
                          ...
                          <div class="row form-group">
                            <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min1']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min2']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min3']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min4']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min5']; ?>" readonly></div>
                          </div>    
                          <div class="row form-group">
                            <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min6']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min7']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min8']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min9']; ?>" readonly></div>
                             <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['min10']; ?>" readonly></div>
                            </div>    
                          </div>    
                         </div>
                         ...
                         <div class="col-xs-2 col-sm-2"></div> 
                          ...
                          <div class="col-xs-8 col-sm-8">
                          <div class="row form-group">
                            <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point1']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point2']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point3']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point4']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point5']; ?>" readonly></div>
                          </div> 
                          <div class="row form-group">
                            <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point6']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point7']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point8']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point9']; ?>" readonly></div>
                              <div class="col col-md-2.5" style=""><input type="text" id="qr-text" name="" class="form-control" value="<?php echo $jsonArray3['point10']; ?>" readonly></div>
                          </div> 
                ...
                <?php } ?>       
                   ...
                   <!--first route-->
                        <div class="row">
                        <div style="margin-left: 2%;margin-bottom:3%;">Add Route :</div><br/>
                        <div style="background-color: #728370;margin-left: 2%;margin-right: 2%;">
                         <div class="col-xs-11 col-sm-11" style="margin-top: 5%;">
                      ...
                      <button type="button" name="add" id="add1" style="">ADD CHECKPOINT</button> <br/><br/><br/>
                         ...
                         <button type="submit" name="submit_save" style="width: 12%;" class="btn btn-primary btn-sm">SAVE</button>&nbsp;&nbsp;&nbsp;
