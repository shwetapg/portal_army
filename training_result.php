 ...
 if(isset($_POST['tb_ls'])){
    ...
    $arr3 = json_decode($output2,true);
     ...
     foreach ($arr3 as $value) {
      foreach ($value['training'] as $value1) {
        foreach ($value1 as $value2) {
     $s1= $value2['route_name'];
     $s=$s1;
    }
  }
}
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2"  style="font-weight: bold;">Points</div>
                        ...
                        <div class="card" style="box-shadow: 0 4px 8px 5px rgba(0,0,0,0.2);width:100%;overflow-y: scroll;height:350px;">
                         ...
                         <?php for($i=0;$i<count($arr['route']);$i++){
                       ?>  
                        <tr class="content2">
                         <td><?php echo $arr['route'][$i]['routes']['route_name']; ?></td>

                         <?php for($j=0;$j<count($arr['route'][$i]['check_points']);$j++){
                         ?> 
                          <?php for($k=0;$k<count($arr['route'][$i]['check_points'][$j]['check_point']);$k++){
                         ?> 
                      
                            <td class="<?php echo "ck".$i; ?>"><?php $p1=$arr['route'][$i]['check_points'][$j]['check_point'][$k]['point1']; $p2=$arr['route'][$i]['check_points'][$j]['check_point'][$k]['point2']; $p3=$arr['route'][$i]['check_points'][$j]['check_point'][$k]['point3']; $p4=$arr['route'][$i]['check_points'][$j]['check_point'][$k]['point4']; $p5=$arr['route'][$i]['check_points'][$j]['check_point'][$k]['point5']; $p6=$arr['route'][$i]['check_points'][$j]['check_point'][$k]['point6']; $p_total=$p1+$p2+$p3+$p4+$p5+$p6; echo $p_total; ?></td>

                          <?php } ?>  
                          <?php } ?>  
                           <td id="<?php echo "ck_ttl".$i; ?>"></td>    
                        </tr>
                      ...
                      <td><?php $s2=$arr3[$i-1][$j]['stop_time']; $s1=$arr3[$i][$j]['start_time'];  $sss=( strtotime($s1) - strtotime($s2) ) / 60; $m1=$arr3[$i][1]['check_point'][$p]['min1']; $m2=$arr3[$i][1]['check_point'][$p]['min2']; $m3=$arr3[$i][1]['check_point'][$p]['min3']; $m4=$arr3[$i][1]['check_point'][$p]['min4']; $m5=$arr3[$i][1]['check_point'][$p]['min5']; $m6=$arr3[$i][1]['check_point'][$p]['min6']; if($sss<=$m1){ echo $arr3[$i][1]['check_point'][$p]['point1'];} elseif($sss<=$m2){ echo $arr3[$i][1]['check_point'][$p]['point2'];} elseif($sss<=$m3){ echo $arr3[$i][1]['check_point'][$p]['point3'];} elseif($sss<=$m4){ echo $arr3[$i][1]['check_point'][$p]['point4'];} elseif($sss<=$m5){ echo $arr3[$i][1]['check_point'][$p]['point5'];} elseif($sss>=$m6){ echo $arr3[$i][1]['check_point'][$p]['point6'];} ?> </td> 
                       ...
                       <?php $i=0; foreach ($jsonArray2 as $key=>$jsonArray3) {
                       ...
                       ?>
                           <tr class="content2">
                            ...
                            <!-- <td><?php $s1=$jsonArray3['stop_time']; $s2=$jsonArray3['start_time'];  $sss=( strtotime($s1) - strtotime($s2) ) / 60; echo $sss." Mins"; echo $jsonArray2[$key -1]['start_time']; ?></td>  -->
