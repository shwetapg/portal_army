...
?> 
  ...
  <?php
    ...
    {
      $s=$_POST['pk'];
     $url1 = 'https://api.neptune.bitjiniapps.com/add_area/'.$s.'/';
            $options1 = array(
              'http' => array(
              'header'  => array(
                        'Authorization: '.'Token 7733513f8a2d44f607ebd4135a5d6a484644776b',
            ...
            echo '<script>alert("Deleted Area Successfully");</script>';
            echo "<script>location='exersicee_db.php'</script>";
      }
    ?>
  <?php  
    if(isset($_POST['submit_area_edit']))
    { 
      $_SESSION['pk']=$_POST['pk'];
      $_SESSION['name']=$_POST['name'];
      echo "<script>location='edit_exersice.php'</script>"; 
    }
  ?>   
  ...
  <!-- Left Panel -->
    ...
    <div class="animated fadeIn">
       <div class="top_hd" style="text-align:center;margin-top:2%;"><h3>Exersice List</h3></div>
      <div class="top_hd" style="text-align:center;margin-top:1%;"><h4><?php echo count($arr1);?> Exersices</h4></div><br/>
        ...
        <div class="row fltr_opt" >
          ...
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <button type="button" class="form-control" id="add_video" onclick="window.location.href='./add_exersice.php'" style="cursor: pointer;background-color:#728370;color:#fff;border-radius: 7px 6px;height: 44px;">Add Exersice</button>
          </div>
        </div><!--row--><br/>
          ...
          <table class="table table-bordered table-striped" style="box-shadow:0 0px 0px rgba(0,0,0,0.16), 0 1px 1px rgba(0,0,0,0.23);background-color:white;margin-left:3%;overflow:auto;">
            ...
            <tbody id="myTable" >
              ...
              <tr style="color:black;" class="content1">
                ...
                <td><?php echo $jsonArray['name']; ?></td>
                <td><form method="post"><input type="hidden" name="pk" value="<?php echo $jsonArray['pk']; ?>"><input type="hidden" name="name" value="<?php echo $jsonArray['name']; ?>"><button type="submit" name="submit_area_edit" class="btn" style="background-color:#728370;color:#fff;"><i class="fa fa-edit"></i></button></form></td>
                <td><form method="post"><input type="hidden" name="pk" value="<?php echo $jsonArray['pk']; ?>"><button type="submit" name="delete" class="btn btn-danger" onclick="return confirm('Delete Exersice?')"><i class="fa fa-trash"></i></button></form></td>
              </tr>
