...
<body style="background-color:#e6e5e5;">
 ...
 <?php  
        if(isset($_POST['submit1'])){
          $s=$_SESSION['pk'];
        $url = 'https://api.neptune.bitjiniapps.com/add_area/'.$s.'/';
        $data = array(
                    'name'=>$_POST['name'],
                   );
          ...
          // print_r($arr1);
        echo '<script>alert("Updated Exersice Successfully");</script>';
                    ...
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <div class="col-xs-8 col-sm-8">
                            <div class="row form-group">
                               ...
                               <div class="col-12 col-md-8"><input type="text" id="route" name="name" value="<?php echo $_SESSION['name']; ?>" class="form-control" required></div>
                            </div>
