                    ...
                    <div class="col-xs-12 col-sm-12">
                     ...
                     <form enctype="multipart/form-data" method="post" id="upload_form2">    
                        ...
                        <div class="col-xs-8 col-sm-8">
                            ...
                            <!--  <div class="row form-group">
                               ...
                               <div class="col-12 col-md-8">
                                <img src="<?php echo $_SESSION['img']; ?>" id="imgshow1" width="100" height="100" />
                               </div>
                            </div> -->

                            <div class="row form-group">
                               <div class="col col-md-4" style="text-align: end;"><label for="name1">Name:</label></div>
                               <div class="col-12 col-md-8"><input type="text" value="<?php echo $_SESSION['name']; ?>" id="name1" name="full_name" class="form-control" ></div>
                            </div>
                            
                            <div class="row form-group">
                               <div class="col col-md-4" style="text-align: end;"><label for="reg_no">Reg No:</label></div>
                               <div class="col-12 col-md-8"><input type="text" name="reg_no" value="<?php echo $_SESSION['reg_no']; ?>" class="form-control" ></div>
                            </div>

                            <!-- <div class="row form-group">
                               <div class="col col-md-4" style="text-align: end;"><label for="reg_date">Reg Date:</label></div>
                               <div class="col-12 col-md-8"><input type="date" name="reg_date" class="form-control" value="<?php echo $_SESSION['reg_date'];?>" >
                               </div>
                            </div> -->
                        ...
                        <div class="col-xs-2 col-sm-2"></div> 
                         ...
                         <button type="submit" style="width: 12%;" class="btn btn-primary btn-sm">Update</button>&nbsp;&nbsp;&nbsp;
...
$( '#upload_form2' )
  .submit( function( e ) {
    e.preventDefault();
    $.ajax( {
      url: 'https://api.neptune.bitjiniapps.com/add_commando/'+pk+'/',
      type: 'PUT',
      ...
      success: function (data){
        // alert(data);
        alert("Updated Commando  Successfully");
