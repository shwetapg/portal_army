...
?> 
  ...
  <?php  
        ...
        $data1 = array(
          ...
          // print_r($arr3);
          // echo "string";
        echo '<script>alert("Successfully Done Training Start");</script>';
    ...
    <?php  
        ...
        $data1 = array(
          ...
          // print_r($arr3);
          // echo "string";
        echo '<script>alert("Successfully Done Training End");</script>';
        echo "<script>location='training_db.php'</script>";
       }
    ?>
        ...
        <div class="content cntnt">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <div class="row">
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-6"><input type="text" id="" name="route1_name" class="form-control" style="" value="<?php echo $jsonArray1['routes']['route_name']; ?>" readonly></div>
                          </div>
                         </div> 
                     ...
                     ?> 
                         ...
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            <div class="col col-md-6" style="text-align: end;"><label for="checkpt">Check Point <?php if(empty($jsonArray3)){ $count2;} else {$count2++;} echo $count2; ?>:</label></div>
                            <div class="col-12 col-md-6"><input type="text" id="" name="checkpt1r1_name" class="form-control" value="<?php echo $jsonArray3['check_point_name']; ?>" readonly></div>
                          </div>
                         </div> 
                          <div class="col-xs-6 col-sm-6"></div>    
                         </div>
                         ...
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-6">
                            <select  name="check_pt1r1_status" class="form-control" readonly>
                         ...
                         <div class="col-xs-6 col-sm-6">
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-3"><input type="text" id="" name="distance_ckpt1r1" class="form-control" style="width: 130%;" value="<?php echo $jsonArray3['distance']; ?>" readonly></div>
                ...
                <?php } ?>       
                         ...
                         <button type="submit" name="submit1" style="width: 12%;" class="btn btn-primary btn-sm" onclick="return confirm('Start Training?')">START</button>&nbsp;&nbsp;&nbsp;
                          <button type="submit"  name="submit2" style="width: 12%;" class="btn btn-danger btn-sm" onclick="return confirm('End Training?')">END</button>&nbsp;&nbsp;&nbsp;
