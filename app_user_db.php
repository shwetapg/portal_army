...
<body style="background-color:#e6e5e5;">
   <?php
    $url2 = 'https://api.neptune.bitjiniapps.com/add_instructor/';
    $options = array(
            'http' => array(
              'header'  => array(
...
?> 
  ...
  <!-- Left Panel -->
    ...
    <div class="animated fadeIn">
      <div class="top_hd" style="text-align:center;margin-top:2%;"><h3>App User Database</h3></div>
      <div class="top_hd" style="text-align:center;margin-top:1%;"><h4><?php echo count($arr1);?> App Users</h4></div><br/>

        <div class="row fltr_opt" >
          <div class="col-xs-12 col-sm-1 col-md-1 col-lg-1"></div>
          <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="">
            <input class="form-control srch" placeholder="Search" id="myInput" type="text" style="">
          </div>
          ...
          <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2"></div>
           ...
           <div style="color:black;" class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <button type="button" class="form-control" onclick="window.location.href='./add_instructor.php'" style="cursor: pointer;background-color: #728370;color:#fff;border-radius: 7px 6px;height: 44px;">Add User</button>
          </div> <br/>
        ...
        <div class="breadcrumbs">
          ...
          <table class="table table-bordered table-striped" style="box-shadow:0 0px 0px rgba(0,0,0,0.16), 0 1px 1px rgba(0,0,0,0.23);background-color:white;margin-left:3%;overflow:auto;">
            ...
            <tbody id="myTable" >
              <?php foreach ($arr1 as $jsonArray) {
              ?>
              <tr style="color:black;" class="content1">
                <td><?php echo $jsonArray['full_name']; ?></td>
                <td><?php echo $jsonArray['mobile']; ?></td>
                <td><?php echo $jsonArray['username']; ?></td>
                <td><?php echo $jsonArray['password']; ?></td>
