...
<body style="background-color:#e6e5e5;">
 ...
 <?php  
        ...
        $url = 'https://api.neptune.bitjiniapps.com/add_instructor/';
        $data = array(
        ...
        echo "<script>location='app_user_db.php'</script>";
        }
    ?> 
                       ...
                       <div class="col-xs-2 col-sm-2"></div>       
                        <div class="col-xs-8 col-sm-8">
                             ...
                             <div class="row form-group">
                               <div class="col col-md-4" style="text-align: end;"><label for="name">Name:</label></div>
                               <div class="col-12 col-md-8"><input type="text" id="name" name="name" class="form-control" required></div>
                            </div>

                             <div class="row form-group">
                               <div class="col col-md-4" style="text-align: end;"><label for="mobile">Mobile:</label></div>
                               <div class="col-12 col-md-8"><input type="text" id="mobile" name="mobile" class="form-control" required></div>
                            </div>

                            <div class="row form-group">
                               <div class="col col-md-4" style="text-align: end;"><label for="username">Username:</label></div>
                               <div class="col-12 col-md-8"><input type="text" id="username" name="username" class="form-control" required></div>
                            </div>
                            
                            <div class="row form-group">
                               <div class="col col-md-4" style="text-align: end;"><label for="password">Password:</label></div>
                               <div class="col-12 col-md-8"><input type="text" id="password" name="password" class="form-control" required></div>
                            </div>
                        ...
                        <div class="col-xs-2 col-sm-2"></div>
                         ...
                         <button type="button" style="width: 12%;" class="btn btn-danger btn-sm" onclick="window.location.href='./app_user_db.php'">Cancel</button>
